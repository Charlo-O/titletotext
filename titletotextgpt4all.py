...
class DocumentSearchApp:
    ...
    def setup_ui(self):
        ...
        main_frame.grid_rowconfigure(3, weight=1)  # Make result frame expandable
    ...
    def process_document(self):
        ...
        def process():
            ...
            stop_button = ttk.Button(
                self.root,
                text="停止处理",
                command=self.stop_processing_handler,
    ...
    def stop_processing_handler(self):
        """Stop the processing of documents"""
    ...
    def search_content(self, title):
        try:
            ...
            prompt = '''# 你是一位顶级AI研究员，专注于深度学习模型和计算机视觉领域。
